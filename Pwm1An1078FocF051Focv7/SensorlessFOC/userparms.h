...
#define INITIALTORQUE			0.2		// Initial Torque demand in Amps.

#define ENDSPEEDOPENLOOP MINSPEEDINRPM

#define POLEPAIRS      		2       // Number of pole pairs
#define PHASERES			((float)1.6)	//38 Phase resistance in Ohms.

#define PHASEIND_LQ		((float)0.0024)		//95
#define PHASEIND			((float)0.0024)//(Ld+Lq)/2 Phase inductance in Henrys.
...
#define RSHUNT			0.05	// Value in Ohms of shunt resistors used.
#define DIFFAMPGAIN	5.0		// Gain of differential amplifier.
...
#define     WKP        Q15(0.999)
#define     WKI        Q15(0.0105)
